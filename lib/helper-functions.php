 ...
 * Sant Joan de Gracia.
 *
 * This file adds the required helper functions used in the Sant Joan de Gracia Theme.
 *
 ...
 */
function sjdg_customizer_get_default_link_color() {
 ...
 */
function sjdg_customizer_get_default_accent_color() {
 ...
 */
function sjdg_color_contrast( $color ) {
 ...
 */
function sjdg_color_brightness( $color, $change ) {
